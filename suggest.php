...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
     ...
     $category = trim(filter_input(INPUT_POST, "name", FILTER_SANITIZE_STRING));
     $title = trim(filter_input(INPUT_POST, "name", FILTER_SANITIZE_STRING));
     $format = trim(filter_input(INPUT_POST, "name", FILTER_SANITIZE_STRING));
     $genre = trim(filter_input(INPUT_POST, "name", FILTER_SANITIZE_STRING));
     $year = trim(filter_input(INPUT_POST, "name", FILTER_SANITIZE_STRING));
     ...
     if (!isset($error_message)) {
          ...
          $mail->addAddress('samplemail', 'Adam');     // Add a recipient
